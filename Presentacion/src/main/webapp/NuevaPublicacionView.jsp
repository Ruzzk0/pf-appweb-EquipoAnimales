...
<body>
    ...
    <div class="nueva-publicacion-container">
        <div class="card nueva-publicacion-card">
            <form id="formPublicar" action="${pageContext.request.contextPath}/NuevaPublicacionController" 
                  method="post" enctype="multipart/form-data" class="formularioPublicacion">
                ...
                <div class="form-group">
                    <input type="hidden" name="autor" value="<%= request.getAttribute("_id") %>">
                ...
                <div class="card-body">
                    <div class="form-group imagen-upload">
                        <label for="imagenPost" class="imagen-label">
                            <input type="file" id="imagenPost" name="imagen" accept="image/*" class="imagen-input" required>
