...
public class checkSessionServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Obtener el valor de "isLoggedIn" de la sesión
        Boolean isLoggedIn = (Boolean) request.getSession().getAttribute("isLoggedIn");

        // Si no existe el atributo, se considera que no está logueado
        if (isLoggedIn == null) {
            isLoggedIn = false;
        }

        // Enviar la respuesta como un JSON con el estado de la sesión
    ...
    public String getServletInfo() {
        return "Servlet para verificar el estado de la sesión";
    }// </editor-fold>
